...
describe('StripePayment', () => {
    ...
    describe('createPaymentIntent', () => {
        ...
        it('should throw an error when creating a payment intent fails', async () => {
            ((mockStripe.paymentIntents.create as jest.Mock) as jest.Mock).mockRejectedValue(new Error('Failed to create payment intent'));
    ...
    describe('retrievePaymentIntent', () => {
        ...
        it('should throw an error when retrieving a payment intent fails', async () => {
            (mockStripe.paymentIntents.retrieve as jest.Mock).mockRejectedValue(new Error('Failed to retrieve payment intent'));
    ...
    describe('confirmPaymentIntent', () => {
        ...
        it('should throw an error when confirming a payment intent fails', async () => {
            (mockStripe.paymentIntents.confirm as jest.Mock).mockRejectedValue(new Error('Failed to confirm payment intent'));
